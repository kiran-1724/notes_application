<x-app-layout>
    ...
    <div class="py-8" x-data="{ deleteUrl: '' }">
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
                <div class="p-8">
                    ...
                    <div class="mb-8">
                        ...
                        <!-- Note Metadata -->
                        <div class="flex flex-wrap items-center gap-6 text-sm text-slate-600 bg-gray-50 px-4 py-3 rounded-lg">
                            ...
                            <div class="flex items-center">
                                ...
                                <span>{{ str_word_count($note->content) }} words</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="prose prose-slate max-w-none">
                        <div class="text-slate-800 text-base leading-relaxed whitespace-pre-wrap font-normal" style="word-wrap: break-word; overflow-wrap: break-word;">
                            {{ $note->content }}
                        </div>
                    </div>
                </div>
                ...
                <div class="px-8 py-4 bg-gray-50 border-t border-gray-200 rounded-b-xl">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('notes.edit', $note) }}" 
                           class="inline-flex items-center px-4 py-2 text-sm font-medium text-amber-700 bg-amber-50 rounded-lg hover:bg-amber-100 border border-amber-200 transition-colors duration-200">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                            </svg>
                            Edit Note
        ...
        <!-- Use the reusable delete modal component with note title -->
